// Lista de verificação por tipo de ato — o que o cartório confere em cada
// escritura. Nasceu no analisar-caso e é a mesma coisa que o bot do WhatsApp e
// o Apps Script usam pra guiar a IA; ficou aqui pra deixar de existir em
// cópias que envelhecem separadas. (A cópia do Apps Script continua lá porque
// aquele runtime do Google não tem require.)
...
module.exports = { INSTRUCOES_POR_TIPO, instrucoesPorTipo };
