...
- **Ele chama o Apps Script** (`convidar-evento-calendar`, ação nova em
  `apps-script/cartorio-drive-api.js`): compromisso do Bússola com e-mails
  vira evento com convidados na agenda da conta do Apps Script.
