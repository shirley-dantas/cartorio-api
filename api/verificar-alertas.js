...
Para AGENDA DE HOJE e AGENDA DE AMANHÃ, gere normalmente um item por caso, escrito como mensagem calorosa e pessoal dirigida à Shirley, mencionando os detalhes reais da observação (quem está envolvido, horário), terminando com uma pergunta de confirmação. Deixe claro no texto se é hoje ou amanhã. Exemplos de tom (adapte aos dados reais, nunca copie o exemplo): "Oi Shirley, a escritura do Carlos Cesar vai ser assinada hoje pelo Reinaldo às 14:30 — já está tudo certo?" ou "Lembrete: amanhã tem a assinatura do Reinaldo no caso do Carlos Cesar, às 14:30 — já está tudo encaminhado?"

CONSOLIDAÇÃO — quando vale juntar vários casos num item só: se dois ou mais casos descreverem claramente o MESMO compromisso compartilhado (mesma data E mesmo horário E as mesmas pessoas chegando pro mesmo motivo — ex: "a construtora e os procuradores vêm assinar" aparecendo em vários casos como a mesma sessão/visita), gere UM ÚNICO item cobrindo todos eles, em vez de um item repetido e quase idêntico pra cada caso. Nesse item consolidado, o campo "nome" deve listar os nomes dos casos separados por vírgula (com "e" antes do último), e a "mensagem" deve mencionar todos os casos/unidades envolvidos numa frase só, deixando claro que é uma sessão/compromisso compartilhado. NÃO consolide só porque é no mesmo dia, ou por status parecido — só quando for evidente que é o mesmo evento acontecendo junto, no mesmo horário. Casos com compromissos independentes (datas/horários diferentes, ou mesmo dia mas sem relação entre si) continuam cada um com seu próprio item.
