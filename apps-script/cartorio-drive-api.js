...
- DIFERENÇA CRÍTICA EM RELAÇÃO AO VALOR VENAL — AQUI O NÚMERO NUNCA FICA EM BRANCO: o valor venal de referência pode ficar em R$______ porque o TOTAL dele às vezes não está em documento nenhum do caso. O preço da transação é diferente: o valor total da venda é sempre um dado conhecido do caso (é o preço negociado), então o valor de cada unidade dentro dele é sempre uma conta que dá pra fechar — FAÇA A CONTA (preço total × área da unidade ÷ área total do conjunto) e escreva o resultado em reais e por extenso, como qualquer outro valor da minuta. Só deixe R$______ aqui se o PRÓPRIO preço total da venda também for desconhecido — nunca porque a divisão "parece" incompleta. Exemplo de como fica quando o preço total é R$ 700.000,00, a área do apartamento é 196,28 m² e a área total do conjunto é 235,88 m²: o apartamento corresponde a 83,2262% (oitenta e três vírgula dois mil duzentos e sessenta e dois por cento) desse preço, ou seja, R$ 582.583,40 (quinhentos e oitenta e dois mil, quinhentos e oitenta e três reais e quarenta centavos) — um número calculado e completo, nunca "R$______".
